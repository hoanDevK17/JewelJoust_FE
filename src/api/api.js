...
export const APIauctionrequestsell = (jewelryName, jewelryDescription, jewelryInitialPrice, token) => api.post("request-sale",{jewelryname: jewelryName, jewelrydescription: jewelryDescription, jewelryinitialprice: jewelryInitialPrice, headers: {'Authorization': `Bearer ${token}`}})
