...
export default function AuctionRequestSell() {
  ...
  const [messageErrorImage, setMessageErrorImage] = useState(
    "You must upload image of certificate and jewelry to accept"
  );
    ...
    if (user != null) {
      if (urlJewelry?.length > 1) {
        ...
        setMessageErrorImage(
          "You must have at least two images: one for certificate and one for jewelry"
        );
      }
    } else {
                  ...
                  >
                    ...
                    <Form.Item>
                      ...
                      >
                        <>
                          <div className="container">
                            ...
                            <p>
                              1.2 Sellers must provide detailed information
                            ...
                            <p>
                              3.1 The auction ends when the auction time is
                              over.
                            </p>
                            <p>
                            ...
                            <p>
                              4.3 Sellers will receive the money after the
                              system confirms the successful payment.
                            </p>

                            <h2>5. Additional Regulations</h2>
                            <p>
                              5.1 Users (sellers and bidders) must comply with
                              the systems rules and terms.
                            </p>
                            <p>
                      ...
                      <Popconfirm
                        ...
                        description="Are you sure to submit has images of certificates and image of jewelry"
                        onConfirm={confirm}
                        onCancel={cancel}
                        okText="Confirm"
                        cancelText="Cancel"
