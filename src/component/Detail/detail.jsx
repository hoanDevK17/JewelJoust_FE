                ...
                <div className='container'>
                    ...
                    <div className='product-card'>
                        ...
                        <p style={{
                            ...
                            <div className='product-price'><p style={{
                                marginBottom: "0px",
                            }}>Initial Price:</p>{price}$
                            </div>
                            <p style={{
                                marginBottom: "0px"
                            }}>Selling Time:</p>{product.sellTime}
                            <p style={{
                                marginBottom: "0px"
                            }}>Deposit Time:</p>{product.afterTime}
                            <p style={{
                                marginBottom: "0px"
                            }}>Profile Cost:</p>{product.profileCost}$
                            <p style={{
                                marginBottom: "0px"
                            }}>Leap:</p>{product.jump}$
                            <p style={{
                                marginBottom: "0px"
                            }}>Deposit Fee:</p>{product.depositFee}$
                            <p style={{
                                marginBottom: "0px"
                            }}> Auction Form:</p>{product.hinhThuc}
                            <div className='button-outside'>
                                <Link to={`detail/${product.id}`}>
                                    <p><button className='button-detail'>Auction Register</button></p>
                                </Link>
                            </div>
                        </div>
